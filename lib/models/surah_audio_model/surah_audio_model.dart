class SurahAudioModel {
  ...
  SurahAudioModel({this.code, this.status, this.data});

  SurahAudioModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Ayahs {
  ...
  Ayahs.fromJson(Map<String, dynamic> json) {
    ...
    // Safely handle the sajda field
    if (json['sajda'] is bool) {
      sajda = json['sajda'];
    } else {
      sajda = null; // or set a default value (e.g., false)
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['sajda'] = sajda; // This will be either a boolean or null
    return data;
  }
}
